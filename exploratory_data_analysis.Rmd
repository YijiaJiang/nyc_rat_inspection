...
Based on the whole range of temperatures in 2021, we found that more rat inspections happened when temperatures were between 20 and 30 degrees Celsius, indicating that rats preferred a warm environment. However, the temperatures were almost above 0 degree Celsius and we could not determine immediately whether rats seldom wandered outside when the temperatures were extremely low. 
