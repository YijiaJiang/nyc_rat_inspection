...
The full multiple linear regression model we constructed is $borough\_monthly\_cases= \beta_0+ \beta_1(inspectionMonth) + \beta_2(borough) + \beta_3(covid) + \beta_4(avg\_precipitaiton) + \beta_5(avg\_snowFall) + \beta_6(avg\_snowDepth) + \beta_7(avg\_temperature)$. The result shown that the p-value of `inspectionMonth`, `avg_precipitaiton`, `avg_snowFall`, and `avg_temperature` were greater than 0.05, which had to be analyzed by stepwise regression method.
