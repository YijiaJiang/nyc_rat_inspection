...
In this section, we are intended to construct a linear model to generate the monthly number of rats observed using a variety of potential predictors potential predictors, together with its diagnostics and validation. This regression model will be further utilized in the Shiny App for rat activity prediction. 
