...
As stated in our motivation, we search for some work related with rat inspection in NYC.
...
Detailed information concerning our data analysis project plan can be found in our [proposal](https://yijiajiang.github.io/nyc_rat_inspection/proposal.html).
...
$borough\_monthly\_cases= \beta_0+ \beta_1(borough) + \beta_2(covid) + \beta_3(avg_snowFall) + \beta_4(avg\_snowDepth)$
